 ...
 * 
 * Bold but friendly typography hierarchy:
 * - Display: Bold (not Black) for hero text
 * - Headlines: SemiBold for section headers
 * - Titles: Medium weight for readability
 * - Body: Normal weight for content
 * - Labels: Medium for UI elements
 * 
 * This creates visual impact while remaining approachable and readable.
 */
val Typography = Typography(
    ...
    // Title - Card titles, list item headings
