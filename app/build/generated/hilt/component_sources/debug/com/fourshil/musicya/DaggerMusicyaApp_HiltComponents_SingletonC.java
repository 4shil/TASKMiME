...
public final class DaggerMusicyaApp_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends MusicyaApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.crossfadeManagerProvider = DoubleCheck.provider(new SwitchingProvider<CrossfadeManager>(singletonCImpl, 4));
      this.playerControllerProvider = DoubleCheck.provider(new SwitchingProvider<PlayerController>(singletonCImpl, 1));
      this.audioEngineProvider = DoubleCheck.provider(new SwitchingProvider<AudioEngine>(singletonCImpl, 5));
      this.provideAppDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<AppDatabase>(singletonCImpl, 7));
      this.provideMusicDaoProvider = DoubleCheck.provider(new SwitchingProvider<MusicDao>(singletonCImpl, 6));
      this.musicRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MusicRepository>(singletonCImpl, 8));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new PlayerController(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.sleepTimerManagerProvider.get(), singletonCImpl.playbackSpeedManagerProvider.get(), singletonCImpl.crossfadeManagerProvider.get());
          ...
          case 4: // com.fourshil.musicya.player.CrossfadeManager 
          return (T) new CrossfadeManager();

          case 5: // com.fourshil.musicya.player.AudioEngine 
          return (T) new AudioEngine();

          case 6: // com.fourshil.musicya.data.db.MusicDao 
          return (T) DatabaseModule_ProvideMusicDaoFactory.provideMusicDao(singletonCImpl.provideAppDatabaseProvider.get());

          case 7: // com.fourshil.musicya.data.db.AppDatabase 
          return (T) DatabaseModule_ProvideAppDatabaseFactory.provideAppDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 8: // com.fourshil.musicya.data.repository.MusicRepository 
          ...
          case 9: // com.fourshil.musicya.util.LyricsManager 
